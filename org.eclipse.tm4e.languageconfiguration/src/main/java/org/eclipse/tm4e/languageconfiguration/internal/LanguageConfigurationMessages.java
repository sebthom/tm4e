...
public final class LanguageConfigurationMessages extends NLS {
	...
	public static String SelectLanguageConfigurationWizardPage_filter_allFiles;
	public static String SelectLanguageConfigurationWizardPage_filter_jsonFiles;
	public static String SelectLanguageConfigurationWizardPage_filter_languageConfigurationFiles;
